...
namespace org.GraphDefined.WWCP.OCHPv1_4
{
    ...
    public class GetInformProviderResponse : AResponse
    {
        ...
        /// <summary>
        /// Parse the given XML representation of an OCHP get inform provider response.
        /// </summary>
        ...
        /// <summary>
        /// Parse the given text representation of an OCHP get inform provider response.
        /// </summary>
        ...
        /// <summary>
        /// Try to parse the given XML representation of an OCHP get inform provider response.
        /// </summary>
        /// <param name="GetInformProviderResponseXML">The XML to parse.</param>
                                       ...
                                       OnExceptionDelegate            OnException  = null)
        {
            ...
            try
            {
                ...
                GetInformProviderResponse = new GetInformProviderResponse(
                                                ...
                                                GetInformProviderResponseXML.ElementValueOrDefault(OCHPNS.Default + "currency")
        ...
        /// <summary>
        /// Try to parse the given text representation of an OCHP get inform provider response.
        /// </summary>
        /// <param name="GetInformProviderResponseText">The text to parse.</param>
        /// <param name="GetInformProviderResponse">The parsed get inform provider response.</param>
        /// <param name="OnException">An optional delegate called whenever an exception occured.</param>
