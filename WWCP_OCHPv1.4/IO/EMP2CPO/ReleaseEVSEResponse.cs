...
namespace org.GraphDefined.WWCP.OCHPv1_4
{
    ...
    public class ReleaseEVSEResponse : AResponse
    {
        ...
        /// <summary>
        /// Create a new OCHP release EVSE response.
        /// </summary>
        ...
        /// <summary>
        /// Parse the given XML representation of an OCHP release EVSE response.
        /// </summary>
        ...
        /// <summary>
        /// Parse the given text representation of an OCHP release EVSE response.
        /// </summary>
        ...
        /// <summary>
        /// Try to parse the given XML representation of an OCHP release EVSE response.
        /// </summary>
        /// <param name="ReleaseEVSEResponseXML">The XML to parse.</param>
        ...
        /// <summary>
        /// Try to parse the given text representation of an OCHP release EVSE response.
        /// </summary>
        /// <param name="ReleaseEVSEResponseText">The text to parse.</param>
        /// <param name="ReleaseEVSEResponse">The parsed release EVSE response.</param>
        /// <param name="OnException">An optional delegate called whenever an exception occured.</param>
