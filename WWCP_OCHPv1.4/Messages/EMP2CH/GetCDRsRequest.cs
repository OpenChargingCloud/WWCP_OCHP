    ...
    public class GetCDRsRequest : ARequest<GetCDRsRequest>
    {
                                       ...
                                       OnExceptionDelegate  OnException  = null)
        {
            ...
            catch (Exception e)
            {
                ...
                OnException?.Invoke(Timestamp.Now, GetCDRsRequestXML, e);
                                       ...
                                       OnExceptionDelegate  OnException  = null)
        {
            ...
            {
                OnException?.Invoke(Timestamp.Now, GetCDRsRequestText, e);
            }
        ...
        public static Boolean operator == (GetCDRsRequest GetCDRsRequest1, GetCDRsRequest GetCDRsRequest2)
        {
            ...
            if (ReferenceEquals(GetCDRsRequest1, GetCDRsRequest2))
                return true;
