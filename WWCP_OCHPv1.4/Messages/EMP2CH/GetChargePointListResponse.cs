                                                        ...
                                                        GetChargePointListResponse>
    {
                                       ...
                                       OnExceptionDelegate             OnException  = null)
        {
            ...
            catch (Exception e)
            {
                ...
                OnException?.Invoke(org.GraphDefined.Vanaheimr.Illias.Timestamp.Now, GetChargePointListResponseXML, e);
                                       ...
                                       OnExceptionDelegate             OnException  = null)
        {
            ...
            {
                OnException?.Invoke(org.GraphDefined.Vanaheimr.Illias.Timestamp.Now, GetChargePointListResponseText, e);
            }
        ...
        public static Boolean operator == (GetChargePointListResponse GetChargePointListResponse1, GetChargePointListResponse GetChargePointListResponse2)
        {
            ...
            if (ReferenceEquals(GetChargePointListResponse1, GetChargePointListResponse2))
                return true;
