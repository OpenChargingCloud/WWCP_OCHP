                                              ...
                                              GetStatusResponse>
    {
                                       ...
                                       OnExceptionDelegate    OnException  = null)
        {
            ...
            catch (Exception e)
            {
                ...
                OnException?.Invoke(org.GraphDefined.Vanaheimr.Illias.Timestamp.Now, GetStatusResponseXML, e);
                                       ...
                                       OnExceptionDelegate    OnException  = null)
        {
            ...
            {
                OnException?.Invoke(org.GraphDefined.Vanaheimr.Illias.Timestamp.Now, GetStatusResponseText, e);
            }
        ...
        public static Boolean operator == (GetStatusResponse GetStatusResponse1, GetStatusResponse GetStatusResponse2)
        {
            ...
            if (ReferenceEquals(GetStatusResponse1, GetStatusResponse2))
                return true;
