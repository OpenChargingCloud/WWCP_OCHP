...
namespace org.GraphDefined.WWCP.OCHPv1_4.EMP
{
    ...
    /// </summary>
    public class GetChargePointListRequest
    {
                                       ...
                                       OnExceptionDelegate            OnException  = null)
        {
            ...
            catch (Exception e)
            {
                ...
                OnException?.Invoke(DateTime.Now, GetChargePointListRequestXML, e);
                                       ...
                                       OnExceptionDelegate            OnException  = null)
        {
            ...
            {
                OnException?.Invoke(DateTime.Now, GetChargePointListRequestText, e);
            }
        ...
        public static Boolean operator == (GetChargePointListRequest GetChargePointListRequest1, GetChargePointListRequest GetChargePointListRequest2)
        {
            ...
            if (Object.ReferenceEquals(GetChargePointListRequest1, GetChargePointListRequest2))
                return true;
        ...
        /// <returns>True if both match; False otherwise.</returns>
        public Boolean Equals(GetChargePointListRequest GetChargePointListRequest)
        {
