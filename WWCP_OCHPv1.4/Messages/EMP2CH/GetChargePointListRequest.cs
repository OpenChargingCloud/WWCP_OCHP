    ...
    public class GetChargePointListRequest : ARequest<GetChargePointListRequest>
    {
                                       ...
                                       OnExceptionDelegate            OnException  = null)
        {
            ...
            catch (Exception e)
            {
                ...
                OnException?.Invoke(Timestamp.Now, GetChargePointListRequestXML, e);
                                       ...
                                       OnExceptionDelegate            OnException  = null)
        {
            ...
            {
                OnException?.Invoke(Timestamp.Now, GetChargePointListRequestText, e);
            }
        ...
        public static Boolean operator == (GetChargePointListRequest GetChargePointListRequest1, GetChargePointListRequest GetChargePointListRequest2)
        {
            ...
            if (((Object) GetChargePointListRequest1 is null) || ((Object) GetChargePointListRequest2 is null))
                return false;
        ...
        public override Boolean Equals(Object Object)
        {
            ...
            if ((Object) GetChargePointListRequest is null)
                return false;
