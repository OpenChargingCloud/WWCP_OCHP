    ...
    public class ReportDiscrepancyRequest : ARequest<ReportDiscrepancyRequest>
    {
                                       ...
                                       OnExceptionDelegate           OnException  = null)
        {
            ...
            catch (Exception e)
            {
                ...
                OnException?.Invoke(Timestamp.Now, ReportDiscrepancyRequestXML, e);
                                       ...
                                       OnExceptionDelegate           OnException  = null)
        {
            ...
            {
                OnException?.Invoke(Timestamp.Now, ReportDiscrepancyRequestText, e);
            }
        ...
        public static Boolean operator == (ReportDiscrepancyRequest ReportDiscrepancyRequest1, ReportDiscrepancyRequest ReportDiscrepancyRequest2)
        {
            ...
            if (ReferenceEquals(ReportDiscrepancyRequest1, ReportDiscrepancyRequest2))
                return true;
