    ...
    public class ReleaseEVSERequest : ARequest<ReleaseEVSERequest>
    {
                                       ...
                                       OnExceptionDelegate     OnException  = null)
        {
            ...
            catch (Exception e)
            {
                ...
                OnException?.Invoke(org.GraphDefined.Vanaheimr.Illias.Timestamp.Now, ReleaseEVSERequestXML, e);
                                       ...
                                       OnExceptionDelegate     OnException  = null)
        {
            ...
            {
                OnException?.Invoke(org.GraphDefined.Vanaheimr.Illias.Timestamp.Now, ReleaseEVSERequestText, e);
            }
        ...
        public static Boolean operator == (ReleaseEVSERequest ReleaseEVSERequest1, ReleaseEVSERequest ReleaseEVSERequest2)
        {
            ...
            if (ReferenceEquals(ReleaseEVSERequest1, ReleaseEVSERequest2))
                return true;
