    ...
    public class ControlEVSERequest : ARequest<ControlEVSERequest>
    {
                                       ...
                                       OnExceptionDelegate     OnException  = null)
        {
            ...
            catch (Exception e)
            {
                ...
                OnException?.Invoke(org.GraphDefined.Vanaheimr.Illias.Timestamp.Now, ControlEVSERequestXML, e);
                                       ...
                                       OnExceptionDelegate     OnException  = null)
        {
            ...
            {
                OnException?.Invoke(org.GraphDefined.Vanaheimr.Illias.Timestamp.Now, ControlEVSERequestText, e);
            }
        ...
        public static Boolean operator == (ControlEVSERequest ControlEVSERequest1, ControlEVSERequest ControlEVSERequest2)
        {
            ...
            if (ReferenceEquals(ControlEVSERequest1, ControlEVSERequest2))
                return true;
