                                                 ...
                                                 ReleaseEVSEResponse>
    {
                                       ...
                                       OnExceptionDelegate      OnException  = null)
        {
            ...
            catch (Exception e)
            {
                ...
                OnException?.Invoke(Timestamp.Now, ReleaseEVSEResponseXML, e);
                                       ...
                                       OnExceptionDelegate      OnException  = null)
        {
            ...
            {
                OnException?.Invoke(Timestamp.Now, ReleaseEVSEResponseText, e);
            }
        ...
        public static Boolean operator == (ReleaseEVSEResponse ReleaseEVSEResponse1, ReleaseEVSEResponse ReleaseEVSEResponse2)
        {
            ...
            if (ReferenceEquals(ReleaseEVSEResponse1, ReleaseEVSEResponse2))
                return true;

            // If one is null, but not both, return false.
            if (((Object) ReleaseEVSEResponse1 is null) || ((Object) ReleaseEVSEResponse2 is null))
                return false;
        ...
        public override Boolean Equals(Object Object)
        {
            ...
            if ((Object) ReleaseEVSEResponse is null)
                return false;
