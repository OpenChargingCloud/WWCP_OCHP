    ...
    public class GetEVSEStatusRequest : ARequest<GetEVSEStatusRequest>
    {
                                       ...
                                       OnExceptionDelegate       OnException  = null)
        {
            ...
            catch (Exception e)
            {
                ...
                OnException?.Invoke(org.GraphDefined.Vanaheimr.Illias.Timestamp.Now, GetEVSEStatusRequestXML, e);
                                       ...
                                       OnExceptionDelegate       OnException  = null)
        {
            ...
            {
                OnException?.Invoke(org.GraphDefined.Vanaheimr.Illias.Timestamp.Now, GetEVSEStatusRequestText, e);
            }
        ...
        public static Boolean operator == (GetEVSEStatusRequest GetEVSEStatusRequest1, GetEVSEStatusRequest GetEVSEStatusRequest2)
        {
            ...
            if (ReferenceEquals(GetEVSEStatusRequest1, GetEVSEStatusRequest2))
                return true;
