...
namespace cloud.charging.open.protocols.OCHPv1_4.EMP
{
                                                 ...
                                                 ControlEVSEResponse>
    {
        ...
        /// </summary>
        public DateTimeOffset?  SessionTimeout   { get; }
        ...
        public ControlEVSEResponse(ControlEVSERequest  Request,
                                   ...
                                   DateTimeOffset?     SessionTimeout  = null)
...

        {
            ...
            if (SessionTimeout.HasValue && SessionTimeout.Value <= Timestamp.Now)
                                       ...
                                       OnExceptionDelegate      OnException  = null)
        {
            ...
            catch (Exception e)
            {
                ...
                OnException?.Invoke(org.GraphDefined.Vanaheimr.Illias.Timestamp.Now, ControlEVSEResponseXML, e);
                                       ...
                                       OnExceptionDelegate      OnException  = null)
        {
            ...
            {
                OnException?.Invoke(org.GraphDefined.Vanaheimr.Illias.Timestamp.Now, ControlEVSEResponseText, e);
            }
        ...
        public static Boolean operator == (ControlEVSEResponse ControlEVSEResponse1, ControlEVSEResponse ControlEVSEResponse2)
        {
            ...
            if (ReferenceEquals(ControlEVSEResponse1, ControlEVSEResponse2))
                return true;
