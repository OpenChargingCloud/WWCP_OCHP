                                                                 ...
                                                                 GetRoamingAuthorisationListResponse>
    {
                                       ...
                                       OnExceptionDelegate                      OnException  = null)
        {
            ...
            catch (Exception e)
            {
                ...
                OnException?.Invoke(org.GraphDefined.Vanaheimr.Illias.Timestamp.Now, GetRoamingAuthorisationListResponseXML, e);
                                       ...
                                       OnExceptionDelegate                      OnException  = null)
        {
            ...
            {
                OnException?.Invoke(org.GraphDefined.Vanaheimr.Illias.Timestamp.Now, GetRoamingAuthorisationListResponseText, e);
            }
        ...
        public static Boolean operator == (GetRoamingAuthorisationListResponse GetRoamingAuthorisationListResponse1, GetRoamingAuthorisationListResponse GetRoamingAuthorisationListResponse2)
        {
            ...
            if (ReferenceEquals(GetRoamingAuthorisationListResponse1, GetRoamingAuthorisationListResponse2))
                return true;
