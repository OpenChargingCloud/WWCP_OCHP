    ...
    public CDRStatus?  CDRStatus   { get; }
                                       ...
                                       OnExceptionDelegate   OnException  = null)
        {
            ...
            catch (Exception e)
            {
                ...
                OnException?.Invoke(DateTime.Now, CheckCDRsRequestXML, e);
                                       ...
                                       OnExceptionDelegate   OnException  = null)
        {
            ...
            {
                OnException?.Invoke(DateTime.Now, CheckCDRsRequestText, e);
            }
        ...
        public static Boolean operator == (CheckCDRsRequest CheckCDRsRequest1, CheckCDRsRequest CheckCDRsRequest2)
        {
            ...
            if (Object.ReferenceEquals(CheckCDRsRequest1, CheckCDRsRequest2))
                return true;
