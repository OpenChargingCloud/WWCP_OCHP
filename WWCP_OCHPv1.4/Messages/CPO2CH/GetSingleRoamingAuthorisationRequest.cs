    ...
    public EMT_Id  EMTId   { get; }
                                       ...
                                       OnExceptionDelegate                       OnException  = null)
        {
            ...
            catch (Exception e)
            {
                ...
                OnException?.Invoke(Timestamp.Now, GetSingleRoamingAuthorisationRequestXML, e);
                                       ...
                                       OnExceptionDelegate                       OnException  = null)
        {
            ...
            {
                OnException?.Invoke(Timestamp.Now, GetSingleRoamingAuthorisationRequestText, e);
            }
        ...
        public static Boolean operator == (GetSingleRoamingAuthorisationRequest GetSingleRoamingAuthorisationRequest1, GetSingleRoamingAuthorisationRequest GetSingleRoamingAuthorisationRequest2)
        {
            ...
            if (ReferenceEquals(GetSingleRoamingAuthorisationRequest1, GetSingleRoamingAuthorisationRequest2))
                return true;
