...
namespace org.GraphDefined.WWCP.OCHPv1_4.CPO
{
    ...
    /// </summary>
    public class GetRoamingAuthorisationListRequest
    {
                                       ...
                                       OnExceptionDelegate                     OnException  = null)
        {
            ...
            catch (Exception e)
            {
                ...
                OnException?.Invoke(DateTime.Now, GetRoamingAuthorisationListRequestXML, e);
                                       ...
                                       OnExceptionDelegate                     OnException  = null)
        {
            ...
            {
                OnException?.Invoke(DateTime.Now, GetRoamingAuthorisationListRequestText, e);
            }
        ...
        public static Boolean operator == (GetRoamingAuthorisationListRequest GetRoamingAuthorisationListRequest1, GetRoamingAuthorisationListRequest GetRoamingAuthorisationListRequest2)
        {
            ...
            if (Object.ReferenceEquals(GetRoamingAuthorisationListRequest1, GetRoamingAuthorisationListRequest2))
                return true;
        ...
        /// <returns>True if both match; False otherwise.</returns>
        public Boolean Equals(GetRoamingAuthorisationListRequest GetRoamingAuthorisationListRequest)
        {
