    ...
    public class InformProviderRequest : ARequest<InformProviderRequest>
    {
                                       ...
                                       OnExceptionDelegate        OnException  = null)
        {
            ...
            catch (Exception e)
            {
                ...
                OnException?.Invoke(Timestamp.Now, InformProviderRequestXML, e);
                                       ...
                                       OnExceptionDelegate           OnException  = null)
        {
            ...
            {
                OnException?.Invoke(Timestamp.Now, InformProviderRequestText, e);
            }
        ...
        public static Boolean operator == (InformProviderRequest InformProviderRequest1, InformProviderRequest InformProviderRequest2)
        {
            ...
            if (ReferenceEquals(InformProviderRequest1, InformProviderRequest2))
                return true;
