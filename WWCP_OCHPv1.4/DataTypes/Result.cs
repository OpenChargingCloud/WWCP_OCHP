    ...
    public class Result
    {
                                       ...
                                       OnExceptionDelegate  OnException  = null)
        {
            ...
            catch (Exception e)
            {
                ...
                OnException?.Invoke(org.GraphDefined.Vanaheimr.Illias.Timestamp.Now, ResultXML, e);
                                       ...
                                       OnExceptionDelegate  OnException  = null)
        {
            ...
            {
                OnException?.Invoke(org.GraphDefined.Vanaheimr.Illias.Timestamp.Now, ResultText, e);
            }
        ...
        public XElement ToXML()
            ...
            => new XElement(OCHPNS.Default + "result",
                   ...
                   new XElement(OCHPNS.Default + "resultCode",
                       new XElement(OCHPNS.Default + "resultCode",     XML_IO.AsText(ResultCode))
                   ),
