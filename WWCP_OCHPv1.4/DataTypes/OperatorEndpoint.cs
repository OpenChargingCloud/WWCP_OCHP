...
namespace cloud.charging.open.protocols.OCHPv1_4
{
    ...
    public class OperatorEndpoint : ADirectEndpoint
    {
        ...
        public OperatorEndpoint(URL                  URL,
                                String               NamespaceURL,
                                String               AccessToken,
                                String               ValidDate,
                                       ...
                                       OnExceptionDelegate   OnException  = null)
        {
            ...
            try
            {
                ...
                OperatorEndpoint = new OperatorEndpoint(
                                       ...
                                       URL.Parse(OperatorEndpointXML.ElementValueOrFail(OCHPNS.Default + "url")),
            ...
            catch (Exception e)
            {
                ...
                OnException?.Invoke(Timestamp.Now, OperatorEndpointXML, e);
                                       ...
                                       OnExceptionDelegate   OnException  = null)
        {
            ...
            {
                OnException?.Invoke(Timestamp.Now, OperatorEndpointText, e);
            }
