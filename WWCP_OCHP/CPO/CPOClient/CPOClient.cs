...
namespace org.GraphDefined.WWCP.OCHPv1_4
{
    ...
    public partial class CPOClient : ASOAPClient
    {
        ...
        //#region PushEVSEData(EVSEDataRecord,         OCHPAction = insert,   Operator = null, OperatorNameSelector = null, IncludeEVSEDataRecords = null, ...)

        ///// <summary>
        ///// Create a new task pushing a single EVSE data record onto the OCHP server.
        ///// </summary>
        ...
        //                 ActionTypes                                  OCHPAction              = ActionTypes.insert,
        ...
        //#region PushEVSEData(EVSEDataRecords,        OCHPAction = fullLoad, Operator = null, OperatorNameSelector = null, IncludeEVSEDataRecords = null, ...)
        ...
        //                 ActionTypes                                  OCHPAction              = ActionTypes.fullLoad,
        //                 ChargingStationOperator                      Operator                = null,
        //                 ChargingStationOperatorNameSelectorDelegate  OperatorNameSelector    = null,
        //                 Func<EVSEDataRecord, Boolean>                IncludeEVSEDataRecords  = null,
        ...
        //#region PushEVSEData(OCHPAction, params EVSEDataRecords)

        ///// <summary>
        ///// Create a new task pushing EVSE data records onto the OCHP server.
        ///// </summary>
        ///// <param name="OCHPAction">The server-side data management operation.</param>
        ///// <param name="EVSEDataRecords">An array of EVSE data records.</param>
        //public async Task<HTTPResponse<Acknowledgement>>

        //    PushEVSEData(ActionTypes              OCHPAction,
        ...
        //#region PushEVSEStatus(GroupedEVSEStatusRecords, OCHPAction = update, Operator = null, OperatorNameSelector = null, ...)
        ...
        //             result = await _OCHPClient.Query(CPOClientXMLMethods.PushEVSEStatusXML(GroupedEVSEStatusRecords,
        //                                                                                    _OCHPAction,
        //                                                                                    Operator,
        ...
        //#region PushEVSEStatus(EVSEStatusRecord,         OCHPAction = insert, Operator = null, OperatorNameSelector = null, IncludeEVSEStatusRecords = null, ...)

        ///// <summary>
        ///// Create a new task pushing a single EVSE status record onto the OCHP server.
        ///// </summary>
        ...
        //#region PushEVSEStatus(EVSEStatusRecords,        OCHPAction = update, Operator = null, OperatorNameSelector = null, IncludeEVSEStatusRecords = null, ...)

        ///// <summary>
        ///// Create a new task pushing EVSE status key-value-pairs onto the OCHP server.
        ///// </summary>
        ...
        //#region PushEVSEStatus(OCHPAction, params EVSEStatusRecords)

        ///// <summary>
        ///// Create a new task pushing EVSE status records onto the OCHP server.
        ///// </summary>
        ///// <param name="OCHPAction">The server-side data management operation.</param>
        ///// <param name="EVSEStatusRecords">An array of EVSE status records.</param>
        //public async Task<HTTPResponse<Acknowledgement>>

        //    PushEVSEStatus(ActionTypes                OCHPAction,
        ...
        ///// <summary>
        ///// Create an OCHP authorize start request.
        ///// </summary>
        ...
        //                                                                             "OCHP " + Version.Number + " only allows a 8, 14 or 20 hex-character authentication token!"),
        //                                                      IsFault: true);
        ...
        //            result = await _OCHPClient.Query(CPOClientXMLMethods.AuthorizeStartXML(OperatorId,
        //                                                                                   AuthToken,
        //                                                                                   EVSEId,
        //                                                                                   PartnerProductId,
        //                                                                                   SessionId,
        ...
        ///// <summary>
        ///// Create an OCHP authorize stop request.
        ///// </summary>
        ///// <param name="OperatorId">An EVSE Operator identification.</param>
        ///// <param name="SessionId">The OCHP session identification from the AuthorizeStart request.</param>
        ///// <param name="AuthToken">A (RFID) user identification.</param>
        ///// <param name="EVSEId">An optional EVSE identification.</param>
        ///// <param name="PartnerSessionId">An optional partner session identification.</param>
        ///// 
        ...
        //            result = await _OCHPClient.Query(CPOClientXMLMethods.AuthorizeStopXML(OperatorId,
        //                                                                                 SessionId,
        //                                                                                 AuthToken,
        //                                                                                 EVSEId,
        //                                                                                 PartnerSessionId),
        ...
        //            result = await _OCHPClient.Query(SOAP.Encapsulation(ChargeDetailRecord.ToXML()),
        ...
        ///// <summary>
        ///// Pull authentication data from the OCHP server.
        ///// </summary>
        ///// <param name="OperatorId">An Charging Station Operator identification.</param>
        ///// 
        ///// <param name="Timestamp">The optional timestamp of the request.</param>
        ...
        //        var result = await _OCHPClient.Query(CPOClientXMLMethods.PullAuthenticationDataXML(OperatorId),
