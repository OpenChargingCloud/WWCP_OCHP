...
namespace org.GraphDefined.WWCP.OCHPv1_4
{
    ...
    public class AddCDRsResponse : AResponse
    {
        ...
        /// <summary>
        /// An enumeration of charge detail records which had been refused.
        /// </summary>
        ...
        /// <param name="RoamingAuthorisationInfos">An enumeration of charge detail records which had been refused.</param>
        public AddCDRsResponse(Result                Result,
                               IEnumerable<CDRInfo>  RoamingAuthorisationInfos = null)

            : base(Result)

        {

            this.ImplausibleCDRs  = RoamingAuthorisationInfos;
